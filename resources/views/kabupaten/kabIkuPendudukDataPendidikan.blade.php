...
<h1 class="spaceTitle"><strong>Data Penyebaran Tingkat Pendidikan Penduduk</strong></h1></br>
<div>
    <ol class="breadcrumb" style="margin-top: -2%;margin-bottom: 1%;background-color: #fff;padding-left: 0;padding-right: 0;">
        ...
        <li><a>Data Penyebaran Tingkat Pendidikan Penduduk</a></li>
    </ol>
</div>
@endsection
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                    Penyebaran Tingkat Pendidikan Penduduk Berdasarkan Tingkat Pendidikan </br>dan Filter Kecamatan, Tahun, Bulan
                </h4>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                Jumlah Tingkat Pendidikan Penduduk Berdasarkan Tingkat Pendidikan </br>dan Filter Kecamatan, Tahun, Bulan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-JumlahPendidikan/Ds-JumlahPendidikan?:iid=9";
    $view2 = "DB139-JumlahPendidikan/Ds-JumlahPendidikan2?:iid=1";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "pendudukDataPendidikan");
</script>
