...
<h1 class="spaceTitle"><strong>Data Pertumbuhan Keluarga</strong></h1></br>
<div>
    <ol class="breadcrumb" style="margin-top: -2%;margin-bottom: 1%;background-color: #fff;padding-left: 0;padding-right: 0;">
        ...
        <li><a>Data Pertumbuhan Keluarga</a></li>
    </ol>
</div>
@endsection
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Keluarga Berdasarkan Kecamatan dan Filter Tahun, Bulan
                </h4>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Keluarga Berdasarkan Kecamatan dan Filter Tahun, Bulan, Kecamatan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Keluarga Berdasarkan Tahun dan Filter Kecamatan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading panel-head">
                    <h4 class="panel-title">
                        Jumlah Keluarga Berdasarkan Bulan dan Filter Kecamatan, Tahun
                    </h4>
                </div>
                <div class="panel-body rights">
                    <div class="dropdowns">
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-JumlahKK/Ds-KK2?:iid=3";
    $view2 = "DB139-JumlahKK/Ds-KK3?:iid=3";
    $view3 = "DB139-TahunXAxis/Ds-JumlahKKX?:iid=7";
    $view4 = "DB139-TahunXAxis/Ds-JumlahKKXBulan?:iid=3";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "pendudukDataKk");
</script>
