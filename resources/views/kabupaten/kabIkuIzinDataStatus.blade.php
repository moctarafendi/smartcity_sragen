...
<h1 class="spaceTitle"><strong>Data Status Perizinan</strong></h1></br>
<div>
    <ol class="breadcrumb" style="margin-top: -2%;margin-bottom: 1%;background-color: #fff;padding-left: 0;padding-right: 0;">
        ...
        <li><a>Perizinan</a></li>
        <li><a>Data Status Perizinan</a></li>
    </ol>
</div>
@endsection
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                    Jumlah Perizinan Berdasarkan Status Belum Selesai dan Selesai</br>
                    dan Filter Kecamatan, Bulan
                </h4>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                    Jumlah Perizinan Berdasarkan Status Belum Selesai, Ditolak, dan Selesai</br>
                    dan Filter Kecamatan, Bulan
                </h4>
            </div>
            <div class="panel-body rights">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Status Perizinan Berdasarkan Bulan dan Filter Kecamatan, Tahun
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Status Perizinan Berdasarkan Bulan dan Filter Kecamatan, Tahun, Bulan, Jenis Perizinan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Status Perizinan Berdasarkan Jenis Perizinan dan Filter Kecamatan, Tahun , dan Bulan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-TahunXAxis/Ds-StatusPerizinanX2?:iid=5";
    $view2 = "DB139-TahunXAxis/Ds-StatusPerizinanX?:iid=2";
    $view3 = "DB139-TahunXAxis/Ds-StatusPerizinanBulan?:iid=3";
    $view4 = "DB139-JumlahPerizinan/Ds-JumlahPerizinanDetail?:iid=2";
    $view5 = "DB139-JumlahPerizinan/Ds-JumlahPerizinanDetailSplit?:iid=12";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "izinDataStatus");
</script>
