...
<h1 class="spaceTitle"><strong>Data Kemiskinan</strong></h1></br>
<div>
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                    Lima Kecamatan dengan Jumlah Penduduk di Bawah Garis Miskin Terbanyak
                    </br> Berdasarkan Kecamatan dan Filter Tahun, Bulan
                </h4>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title text-center">
                    Lima Kecamatan dengan Jumlah Penduduk Sejahtera Terbanyak
                    </br> Berdasarkan Kecamatan dan Filter Tahun, Bulan
                </h4>
            </div>
            <div class="panel-body rights">
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah penduduk Miskin Berdasarkan Kecamatan dan Filter Tahun, Bulan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Penduduk Miskin Berdasarkan Kecamatan dan Filter Tahun, Bulan, Kecamatan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Penduduk Miskin Berdasarkan Tahun dan Bulan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Penduduk Miskin Berdasarkan Bulan dan Filter Kecamatan, Tahun
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
                        <button class="dropbtnsiku fa fa-download fa-sm"></button>
                            <div class="dropdowns-content">
                                <div onclick="exportToImage6()">Download Image</div>
                                <div onclick="exportToPDF6()">Download PDF</div>
                            </div>
                    </div>
            </div>
            <div class="paddingchart">
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-TOP5/Ds-TOP5Kemiskinan?:iid=3";
    $view2 = "DB139-TOP5/Ds-TOP5Sejahtera?:iid=2";
    $view3 = "DB139-JumlahKemiskinan/Ds-Kemiskinan2?:iid=3";
    $view4 = "DB139-JumlahKemiskinan/Ds-Kemiskinan3?:iid=4";
    $view5 = "DB139-TahunXAxis/Ds-KemiskinanX?:iid=44";
    $view6 = "DB139-TahunXAxis/Ds-JumlahKemiskinanXBulan?:iid=6";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "kemiskinanData");
</script>
...
<script type="text/javascript">
    ...
    function chart6() {
        var containerDiv6 = document.getElementById("chart6"),
    ...
    function exportToPDF6() {
        viz6.showExportPDFDialog();
    }
    function exportToImage6(){
