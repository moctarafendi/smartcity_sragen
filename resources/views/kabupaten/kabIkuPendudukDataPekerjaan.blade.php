...
<h1 class="spaceTitle"><strong>Data Penyebaran Pekerjaan Penduduk</strong></h1></br>
<div>
    <ol class="breadcrumb" style="margin-top: -2%;margin-bottom: 1%;background-color: #fff;padding-left: 0;padding-right: 0;">
        ...
        <li><a>Data Penyebaran Pekerjaan Penduduk</a></li>
    </ol>
</div>
@endsection
        ...
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Lima Pekerjaan atau Profesi Terbanyak Berdasarkan Kecamatan dan Filter Kecamatan, Tahun, Bulan
                </h4>
            </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">
                    Jumlah Penyebaran Pekerjaan Penduduk Berdasarkan Jenis Pekerjaan dan Filter Kecamatan, Tahun, Bulan
                </h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-TOP5/Ds-TOP5Pekerjaan?:iid=4";
    $view2 = "DB139-JumlahPekerjaan/Ds-Pekerjaan?:iid=5";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "pendudukDataPekerjaan");
</script>
