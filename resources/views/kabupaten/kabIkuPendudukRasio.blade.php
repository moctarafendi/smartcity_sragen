...
<h1 class="spaceTitle"><strong>Data Rasio Gender Penduduk</strong></h1></br>
<div>
    <ol class="breadcrumb" style="margin-top: -2%;margin-bottom: 1%;background-color: #fff;padding-left: 0;padding-right: 0;">
        ...
        <li><a>Data Rasio Gender Penduduk</a></li>
    </ol>
</div>
@endsection
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">Rasio Gender (Jenis Kelamin) Penduduk berdasarkan Filter Kecamatan, Tahun, Bulan</h4>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">Rasio Gender (Jenis Kelamin) Penduduk Berdasarkan Kecamatan dan Filter Kecamatan, Tahun, Bulan</h4>
            </div>
            <div class="panel-body rights">
                <div class="dropdowns">
                        <button class="dropbtnsiku fa fa-download fa-sm"></button>
...
<?php 
    ...
    $view = '/views/';
    $view1 = "DB139-TrendGender/Ds-Gender?:iid=7";
    $view2 = "DB139-TrendGender/Ds-TrendGenderBatang?:iid=1";
...
<script type="text/javascript">
    ...
    localStorage.setItem("page_menu", "pendudukDataRasio");
</script>
