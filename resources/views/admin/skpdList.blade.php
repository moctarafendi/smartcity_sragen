...
<h1 class="spaceTitle"><strong>Daftar Sekretariat Kerja Perangkat Daerah (SKPD)</strong></h1>
@endsection
                        ...
                        <table class="table" id="dataTableSkpd" style="margin-top:2%!important;margin-bottom:2%!important;">
                            <thead style="background:#5C8790;color:#fff;">
                                <tr>
                                    ...
                                    <th class="text-center">Id Satda</th>
                                    <th class="text-center">Nama Satda</th>
                                    <th class="text-center">Id Perda</th>
...
<script>
    $(document).ready(function(){
        $("#dataTableSkpd").DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('api.datatable.skpd') }}",
            columns: [
                {data: 'id_skpd', name: 'id_skpd'},
                {data: 'name_skpd', name: 'name_skpd'},
                {data: 'satda_id', name: 'satda_id'},
