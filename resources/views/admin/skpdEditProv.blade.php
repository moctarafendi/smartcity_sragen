...
<h1 class="spaceTitle"><strong>Edit Sekretariat Kerja Perangkat Daerah (SKPD)</strong></h1>
@endsection
    ...
    <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">Edit Data SKPD - Provinsi</h4>
            </div>
            <div class="panel-body">
                {!! Form::model($skpd, ['route' => ['skpd.update', $skpd->id_skpd], 'method' => 'PUT']) !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('name_skpd', $skpd->name_skpd, ['class' => $errors->has('name_skpd') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
                    ...
                    <div class="row" style="margin-top: 1.5%;margin-bottom: 1.5%;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                            <a class="btn btn-whitedusty" href="{{ route('skpdListProv') }}" role="button">Batal</a>
