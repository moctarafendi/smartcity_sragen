...
<h1 class="spaceTitle"><strong>Tambah Satuan Dinas (SATDA) - Kabupaten Kota</strong></h1>
@endsection
            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('kabupaten_id', $kabupaten, null, ['class' => $errors->has('kabupaten_id') ? 'form-control is-invalid' : 'form-control']) !!}
                    ...
                    <div class="row" style="margin-top: 1.5%;margin-bottom: 1.5%;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                            <a class="btn btn-whitedusty" href="{{ route('satdaListKab') }}" role="button">Batal</a>
