...
<h1 class="spaceTitle"><strong>Edit Indikator</strong></h1>
@endsection
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading panel-head">
                <h4 class="panel-title">Edit Data Indikator</h4>
            </div>
            <div class="panel-body">
                {!! Form::model($indi, ['route' => ['indikator.update', $indi->id_indikator], 'method' => 'PUT']) !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('name_indikator', $indi->name_indikator, ['class' => $errors->has('name_indikator') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('otda_id', $otd, null, ['class' => $errors->has('otda_id') ? 'form-control is-invalid' : 'form-control', 'required']) !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('referensi', $indi->referensi, ['class' => $errors->has('referensi') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('data_1', $indi->data_1, ['class' => $errors->has('data_1') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
                            ...
                            <div class="form-group">
                                <label for="data_2">Data 2</label>
                                    {!! Form::text('data_2', $indi->data_2, ['class' => $errors->has('data_2') ? 'form-control is-invalid' : 'form-control', 'required', 'autofocus']) !!}
